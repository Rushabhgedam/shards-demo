...
<h1 align="center" style="border-bottom: none !important; margin-bottom: 5px !important;"><a href="https://designrevision.com/downloads/shards-dashboard-lite-react/">Epaper Admin Console React</a></h1>
<p align="center">
  <a href="#">
    <img src="https://img.shields.io/badge/License-MIT-brightgreen.svg" />
  </a>
  <a href="https://twitter.com/designrevision">
    <img src="https://img.shields.io/twitter/follow/Rushabh Gedam.svg?style=social&label=Follow" />
  </a>
</p>
...
- The layout styles inherited from Epaper Admin Console are pulled in from the `src/shards-dashboard` submodule inside `src/App.js`.
...
If you're looking for something more, check out [Epaper Admin Console Pro React](https://designrevision.com/downloads/shards-dashboard-pro-react/) which features many more custom templates and components. Use the `GITHUB15` coupon code for a **15% discount off the current price**.
